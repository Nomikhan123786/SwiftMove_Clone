      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <a href="/" className="inline-block">
              <img src={Light_logo} alt="SwiftMove" className="h-10 w-auto" />
            </a>

            <p className="mt-4 max-w-xs text-gray-400">
              Professional moving services that make your relocation
              stress-free. Licensed, insured, and trusted by thousands.
            </p>

            {/* Contact Info */}
            <div className="mt-6 space-y-2">
              <a
                href="tel:(555)890-1234"
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-gray-800 py-8 sm:flex-row">
          <p className="text-sm text-gray-500">
            & copy; 2026 SwiftMove. All rights reserved. Licensed & amp;
            Insured.
          </p>
