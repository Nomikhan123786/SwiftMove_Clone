...
const States = () => {
  ...
  return (
    <section data-aos="fade-up" className="border-y border-gray-200 bg-gray-50 py-16 lg:py-20 dark:border-gray-800 dark:bg-gray-900">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          {/* Stat 1 */}
          <div className="text-center" data-aos="fade-up" data-delay="0">
